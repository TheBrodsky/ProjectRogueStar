...
var inputs: Array[SkillNode] = []
var outputs: Array[SkillNode] = []
...
func connect_to(block: SkillNode, port: int) -> bool:
...
func connect_from(block: SkillNode, port: int) -> bool:
...
func _modify_connection(side: Array[SkillNode], block: SkillNode, port: int) -> bool:
