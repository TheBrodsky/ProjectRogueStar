...
func _disconnect_nodes(from_block: ActionBlock, from_port: int, to_block: ActionBlock, to_port: int) -> void:
...
func _disconnect_from_if_connected(from_block: ActionBlock, from_port: int) -> void:
	var to_block: ActionBlock = from_block.outputs[from_port]
	if to_block != null:
...
func _disconnect_to_if_connected(to_block: ActionBlock, to_port: int) -> void:
	var from_block: ActionBlock = to_block.inputs[to_port]
	if from_block != null:
...
func _on_connection_request(from_node: StringName, from_port: int, to_node: StringName, to_port: int) -> void:
	if from_node != to_node:
		var from_block: ActionBlock = find_child(from_node, false) as ActionBlock
		var to_block: ActionBlock = find_child(to_node, false) as ActionBlock
